...
const { Upload, getChalangesByCreator, getChalangeById, like, dislike, getAllChalanges, comment, likeComment, dislikeComment, deleteComment, deleteChalange, EditChalange } = require('./../services/chalanges');
