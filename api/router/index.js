...
router.get("/chalanges/will_fail/:disliker/:disliked/:chalange", (req, res) => { dontLikeChalange(req, res) });
router.get("/chalanges/likecomment/:liker/:comment", (req, res) => { likeComment(req, res) });
router.get("/chalanges/dislikecomment/:liker/:comment", (req, res) => { dislikeComment(req, res) });
router.get("/chalanges/comment/delete/:key/:comment", (req, res) => { deleteComment(req, res) });
...
router.get("/chalanges/undo_will_fail/:disliker/:liked/:chalange", (req, res) => { undoDontLikeChalange(req, res) });
router.get("/chalanges/delete/:key/:chalange", (req, res) => { deleteChalange(req, res) });
